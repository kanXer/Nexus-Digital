...
function SuccessContent() {
  ...
  const displayOrder = matchedOrder || {
    ...
    amount: planId === "basic" ? "\u20B94,999/mo" : planId === "premium" ? "\u20B929,999/mo" : planId === "test" ? "\u20B91/mo" : "\u20B914,999/mo",
    date: new Date().toLocaleDateString("en-IN", { day: "numeric", month: "short", year: "numeric" }),
    purchaseTime: new Date().toLocaleTimeString("en-IN", { hour: "2-digit", minute: "2-digit" }),
    isSubscription: true,
    numericAmount: planId === "basic" ? 4999 : planId === "premium" ? 29999 : planId === "test" ? 1 : 14999,
    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-16 text-center">
        ...
        <p className="text-white/60 text-sm mb-8">
          Your transaction was not successful or could not be verified. No amount was charged. Please try again or contact support.
        </p>
