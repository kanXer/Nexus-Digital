...
export const agencyTimeline = [
  ...
  { year: "2026", event: "Expanding Services", detail: "Added SEO, websites, and automation. Now serving a growing roster of businesses across Gorakhpur, Uttar Pradesh, and India." },
];
