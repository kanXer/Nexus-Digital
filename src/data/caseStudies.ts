...
export const caseStudies: CaseStudy[] = [
  {
    ...
    duration: "Live",
    headline: "Best Neuro Physiotherapy Clinic in Gorakhpur, Uttar Pradesh — Built & Ranked Online",
    problem: "Gorakhpur Mission Rehab, a leading neuro physiotherapy clinic at Divyaman Hospital in Gorakhpur, Uttar Pradesh, needed a strong online presence so patients searching for stroke recovery, paralysis treatment, and neuro rehab near them could find and trust the clinic.",
    solution: "We designed and developed a high-converting healthcare website, fully optimised it with local SEO targeting 'best neuro physiotherapist in Gorakhpur, Uttar Pradesh' and 'neuro physiotherapy near me', and optimised the Google Business Profile to capture local search traffic.",
    results: [
  ...
  },
  {
    ...
    client: "1st Poultry Conclave (Gorakhpur, Uttar Pradesh)",
    industry: "Event / Agriculture",
    service: "Event Website + Lead Generation",
    duration: "Live",
    headline: "1st Poultry Conclave (Gorakhpur, Uttar Pradesh) — Mega Poultry Event Website",
    problem: "The first-ever Poultry Conclave in Gorakhpur, Uttar Pradesh, organised by the UP Government's Animal Husbandry department, needed a modern event website to drive registrations from attendees, exhibitors, and sponsors across Eastern UP.",
  ...
  },
  {
    ...
    duration: "Live",
    headline: "Radhey Radhey Blood Bank — Gorakhpur, Uttar Pradesh's Trusted Blood Bank Goes Digital",
    problem: "Radhey Radhey Charitable Blood & Component Centre, a trusted blood bank serving Gorakhpur, Uttar Pradesh, needed a professional digital platform to help community members find, request, and donate blood online — reducing dependency on offline word-of-mouth and improving emergency response time.",
