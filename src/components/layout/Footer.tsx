...
const socials = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/thenexusdigital.in",
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/thenexusdigital.in",
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/thenexusdigital-in",
  ...
  {
    label: "GitHub",
    href: "https://github.com/kanXer/Nexus-Digital",
