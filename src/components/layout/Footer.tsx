...
const footerLinks = {
  ...
  services: [
    { label: "Website Development in Gorakhpur, Uttar Pradesh", href: "/services#website-automation" },
    { label: "Custom E-Commerce Stores Gorakhpur, Uttar Pradesh", href: "/services#website-automation" },
    { label: "SEO Services in Gorakhpur, Uttar Pradesh", href: "/services#seo" },
    { label: "Local SEO Company Gorakhpur, Uttar Pradesh", href: "/services#seo" },
    { label: "Social Media Agency Gorakhpur, Uttar Pradesh", href: "/services#social-media" },
    { label: "Meta Ads Specialist Gorakhpur, Uttar Pradesh", href: "/services#paid-marketing" },
    { label: "Google Ads Management Gorakhpur, Uttar Pradesh", href: "/services#paid-marketing" },
    { label: "Web & Marketing Pricing Gorakhpur, Uttar Pradesh", href: "/pricing" },
  ],
};
