...
import { Bot, Send, X, Sparkles, MessageCircle, Mail, Phone, Maximize2, Minimize2, Trash2, ArrowDown, User, ChevronDown, ChevronUp, LogIn, Zap, ArrowRight } from "lucide-react";
...
export function ChatWidget() {
  ...
  const send = async (preset?: string) => {
    ...
    // Instant shortcut handlers for Call and WhatsApp
    if (text === "📞 Call Specialist" || text === "Call Specialist") {
      ...
      setMessages((m) => [
        ...
        {
          role: "assistant",
          content: `Connecting you with our senior digital growth specialist at ${config.phone}! If your dialer didn't open automatically, please tap the Call Direct button below:`,
        },
      ]);
      setLastAction("contact");
      return;
    }
    if (text === "💬 Send WhatsApp" || text === "Send WhatsApp") {
      ...
      setMessages((m) => [
        ...
        {
          role: "assistant",
          content: "Opening direct WhatsApp chat with our team at Nexus Digital. You can also tap the button below to message us directly:",
        },
      ]);
      setLastAction("contact");
      return;
