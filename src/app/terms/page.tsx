...
export const metadata: Metadata = {
  ...
  description: `Terms and conditions for using ${config.name}'s digital marketing services. Also includes a glossary of key digital marketing terms — SEO, PPC, ROAS, Local SEO, Meta Ads, and more — defined clearly for business owners across Gorakhpur, Uttar Pradesh & India.`,
  keywords: [
...
const glossaryTerms = [
  {
    ...
    definition:
      "The promotion of products, services, or brands through digital channels such as search engines (Google), social media platforms (Facebook, Instagram), email, and websites. As the best digital marketing agency in Gorakhpur, Uttar Pradesh, we use digital marketing to generate leads and grow businesses across Uttar Pradesh and India.",
  },
  {
  ...
  },
  {
    term: "Local SEO",
    definition:
      "A branch of SEO that focuses on making a business visible in local search results — Google Maps, 'near me' searches, and local keyword rankings. Essential for brick-and-mortar businesses across Gorakhpur, Uttar Pradesh who want to attract customers from their area.",
  },
  {
  ...
  },
  {
    term: "Meta Ads",
    definition:
      "Paid advertising on Meta platforms (Facebook and Instagram). Meta Ads are powerful for brand awareness, retargeting warm audiences, and driving leads for products and services with visual appeal. Our digital marketing agency in Gorakhpur, Uttar Pradesh specialises in high-ROAS Meta Ads campaigns.",
  },
  {
    term: "Google Ads",
    definition:
      "Google's pay-per-click advertising platform that places your business at the top of search results when users search for your service. Google Ads are best for high-intent searches like 'digital marketing agency near me in Gorakhpur, Uttar Pradesh' — where the user is already looking to buy.",
  },
  {
  ...
  },
  {
    ...
    definition:
      "A free Google tool that lets businesses manage how they appear on Google Search and Maps. Optimising your GBP is the #1 Local SEO action for Gorakhpur, Uttar Pradesh businesses — it drives direct calls, map directions, and enquiries from local customers searching nearby.",
  },
  {
  ...
  },
  {
    ...
    definition:
      "Using WhatsApp Business API to automate lead nurturing, appointment reminders, follow-ups, and customer communication. Highly effective for Indian businesses as WhatsApp is the #1 communication app in India. Our digital marketing agency in Gorakhpur, Uttar Pradesh integrates this into complete lead funnels.",
  },
  {
        ...
        <div className="max-w-3xl mx-auto relative z-10 text-center">
          ...
          <p className="text-white/45 text-sm">
            ...
            <Link href="/about" className="text-brand-blue-light hover:underline">
              best digital marketing agency in Gorakhpur, Uttar Pradesh
            </Link>
            , Nexus Digital.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 text-center glass-card rounded-2xl p-8 border border-white/8">
            ...
            <p className="text-white font-bold text-xl mb-6">
              Talk to the{" "}
              <span className="gradient-text">Best Digital Marketing Agency in Gorakhpur, Uttar Pradesh</span>
            </p>
