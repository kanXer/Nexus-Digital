                ...
                <div className="relative z-10">
                  {member.photo ? (
                    <div className="relative w-24 h-24 rounded-full overflow-hidden ring-2 ring-brand-blue/40 mx-auto mb-4 shadow-[0_4px_20px_rgba(220,38,38,0.3)]">
                      <Image src={member.photo} alt={`${member.name} - Digital Marketing Expert at Nexus Digital Marketing Agency Gorakhpur, Uttar Pradesh`} fill sizes="96px" className="object-cover" />
                    </div>
                  ) : (
