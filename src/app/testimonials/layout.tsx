...
export const metadata: Metadata = {
  ...
  title: "Client Testimonials & Reviews | Best Agency in Gorakhpur, Uttar Pradesh",
  description: `Read what clients say about working with ${config.name}, the best digital marketing agency in Gorakhpur, Uttar Pradesh. Verified reviews on our local SEO, social media, PPC, and website designing services.`,
  keywords: [
  ...
  openGraph: {
    ...
    title: "Client Testimonials & Reviews | Best Agency in Gorakhpur, Uttar Pradesh",
    description: `Client reviews and testimonials for ${config.name}, the leading digital marketing company in Gorakhpur, Uttar Pradesh.`,
