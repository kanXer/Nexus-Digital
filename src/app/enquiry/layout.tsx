...
export const metadata: Metadata = {
  ...
  title: "Get a Quote | Best Digital Marketing Agency in Gorakhpur, Uttar Pradesh",
  description: `Submit a digital marketing enquiry to ${config.name}, the best digital marketing agency in Gorakhpur, Uttar Pradesh. Get a customized price quote for SEO, paid ads, web design, or social media management.`,
  keywords: [
  ...
  openGraph: {
    ...
    title: "Get a Quote | Best Digital Marketing Agency in Gorakhpur, Uttar Pradesh",
    description: `Contact the top digital marketing agency in Gorakhpur, Uttar Pradesh to get a customized growth plan and pricing.`,
