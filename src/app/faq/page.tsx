...
const faqGroups = [
  { id: "digital-marketing", label: "Digital Marketing & Local SEO", desc: "SEO, Google Ads, Meta Ads, social media marketing, and local Google Maps dominance", match: ["marketing", "results"] },
  { id: "website", label: "Website Development & E-Commerce", desc: "Next.js, React full-stack apps, e-commerce stores, costs, speed, and maintenance", match: ["website"] },
  { id: "pricing", label: "Pricing & Packages", desc: "Transparent costs, ad budgets, ROI timelines, and zero lock-in contracts", match: ["billing"] },
  { id: "process", label: "Process & Reporting", desc: "How we execute campaigns, weekly sprints, analytics dashboards, and deliverables", match: ["process", "reporting"] },
  { id: "general", label: "Agency & Founder (Sahil Srivastava)", desc: "About Nexus Digital, Founder Sahil Srivastava, team credentials, and regional reach across Gorakhpur, Uttar Pradesh & India", match: ["general"] },
];
