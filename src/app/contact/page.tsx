        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-10">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] as const }} className="lg:col-span-2 space-y-6">
            ...
            <div className="glass-card rounded-2xl overflow-hidden border border-white/8 h-48">
              <iframe
                src={`https://maps.google.com/maps?q=Nexus+Digital+Marketing+Agency+gorakhpur+uttar+pradesh&output=embed`}
                width="100%"
                height="100%"
            ...
            >
              ...
              <span className="text-xs text-white/50 group-hover:text-white/70">({config.gmbRating}/5 Rating · {config.gmbReviewCount}+ Google Reviews)</span>
            </a>
          </motion.div>
            ...
            <div className="glass-card rounded-3xl p-6 md:p-8 border border-white/10">
              {!submitted ? (
                <>
                  ...
                  <p className="text-white/45 text-sm mb-4">Koi bhi problem, sawaal ya help chahiye? Form bharo — hum 24 hours ke andar reply karenge. Best digital marketing agency in Gorakhpur, Uttar Pradesh and India ki complete services ke liye contact karein.</p>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] as const }} className="glass-card rounded-3xl p-6 md:p-10 border border-white/10">
            {!bookingSubmitted ? (
              <>
                ...
                <p className="text-white/45 text-sm mb-4">Pick a date &amp; time that works for you. The team at our digital marketing company in Gorakhpur, Uttar Pradesh will join the call with a custom growth plan — 100% free.</p>
