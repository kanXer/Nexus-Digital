...
export const metadata: Metadata = {
  ...
  title: "Digital Marketing Case Studies | Top Agency in Gorakhpur, Uttar Pradesh",
  description: `In-depth case studies from ${config.name}, the best digital marketing agency in Gorakhpur, Uttar Pradesh. Learn how we generate leads, increase ROAS, and rank local businesses on search engines.`,
  keywords: [
  ...
  openGraph: {
    ...
    title: "Digital Marketing Case Studies | Top Agency in Gorakhpur, Uttar Pradesh",
    description: `Real ROI results from the leading digital marketing company in Gorakhpur, Uttar Pradesh. Read our case studies.`,
