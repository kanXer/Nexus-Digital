...
const portfolioItems = [
  { id: 1, title: "Gorakhpur Mission Rehab (Gorakhpur, Uttar Pradesh)", category: "Websites", tag: "Healthcare", color: "from-teal-500/30 to-cyan-500/20", emoji: "🩺", url: "https://gorakhpurmission.in/", result: "Local SEO · Online Leads" },
  { id: 2, title: "1st Poultry Conclave (Gorakhpur, Uttar Pradesh)", category: "Websites", tag: "Event", color: "from-amber-500/30 to-yellow-500/20", emoji: "🐔", url: "https://poultry-conclave.vercel.app/", result: "Event Registrations" },
  ...
  { id: 4, title: "Radhey Radhey Charitable Blood & Component Centre (Gorakhpur, Uttar Pradesh)", category: "Websites", tag: "Blood Bank", color: "from-red-500/30 to-rose-500/20", emoji: "🩸", url: "https://radhe-radhe-blood-bank.vercel.app/", result: "Online Presence · Community Reach" },
];
