...
export const metadata: Metadata = {
  ...
  title: "Digital Marketing Portfolio | Top Agency in Gorakhpur, Uttar Pradesh",
  description: `See how ${config.name}, the best digital marketing agency in Gorakhpur, Uttar Pradesh, helps brands grow through social media, paid ads, SEO, and website design. Explore our local work samples.`,
  keywords: [
  ...
  openGraph: {
    ...
    title: "Digital Marketing Portfolio | Top Agency in Gorakhpur, Uttar Pradesh",
    description: `Real local results from the best digital marketing agency in Gorakhpur, Uttar Pradesh. View our portfolio.`,
    images: [{ url: config.ogImage, width: 1200, height: 630, alt: `${config.name} — Digital Marketing Portfolio Gorakhpur, Uttar Pradesh` }],
  },
};
